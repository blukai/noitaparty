-- NOTE(blukai): this possibly might provide some additional insights:
-- https://noita.wiki.gg/wiki/Modding:_Lua_API#Mod_Settings_(settings.lua)
...
local mod_id = "noitaparty" -- This should match the name of your mod's folder.
